                  ...
                  <div className="row">
                      <div className="blog-lst col-md-12 pl0">
                          <section className="post">
                              ...
                              <p className="intro">Pellentesque habitant morbi tristique senectus et netus et malesuada
                          ...
                          <div className="col-md-3 col-sm-6 wow fadeInRight animated">
                              <div className="single-footer news-letter">
                                  ...
                                  <div className="social pull-right">
                                      <ul>
                                          <li><a className="wow fadeInUp animated" href="https://twitter.com/kimarotec"><i
